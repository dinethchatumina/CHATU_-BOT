...
async function connectToWA() {
  console.log("Connecting chatuwa-MD 🧬...");
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ chatuwa-MD connected to WhatsApp');

      const up = `chatuwa-MD connected ✅\n\nPREFIX: ${prefix}`;
...
app.get("/", (req, res) => {
  res.send("Hey, chatuwa-MD started✅");
});
